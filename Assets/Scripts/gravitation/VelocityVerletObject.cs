...
public class VelocityVerletObject : MonoBehaviour
{
    ...
    void Start()
    {
        VelocityVerletObjectManager.instance.AddObject(this);
    }

    private void OnDestroy()
    {
        VelocityVerletObjectManager.instance.RemoveObject(this);
    }
    ...
    {
        Vector3 f_next = VelocityVerletObjectManager.instance.CalculateForce(this);
